...
//        Picasso.with(getApplicationContext()).load(URL_Image+image).into(imgview);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        expertadvice = view.findViewById(R.id.expertarticles);
        expertadvice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                System.out.println("this is clicked");
                Intent advice = new Intent(getActivity(), expertadvice.class);
